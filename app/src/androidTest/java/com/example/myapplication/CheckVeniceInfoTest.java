...
@LargeTest
public class CheckVeniceInfoTest {

    public static final String STRING_TO_BE_DISPLAYED_TITLE= "Venice Beach";
    public static final String STRING_TO_BE_DISPLAYED_HOURS = "6am-12am" + "\n" + "101 The Esplanade at the west end of West Venice Avenue.";
    public static final String STRING_TO_BE_DISPLAYED_DESCRIPTION = "Internationally known for its bohemian vibe, this walkable beach offers street performers & a gym.";
    ...
    static {
        ...
        intent.putExtra("beach_name", "venice beach");
    ...
    private Activity getVeniceActivity() {
    ...
    @Test
    public void CheckVenice() {

        TextView name_view = getVeniceActivity().findViewById(R.id.beach_title);
        String name = name_view.getText().toString();
        while (name.equals("")) {
            name_view = getVeniceActivity().findViewById(R.id.beach_title);
